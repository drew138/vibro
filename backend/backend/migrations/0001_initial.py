# Generated by Django 3.0.7 on 2021-01-09 18:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(default='', max_length=17, validators=[django.core.validators.RegexValidator(message='El número de teléfono debe ser entrado en el formato: (+xxx) xxx xxxx ext xxx siendo el código de área y la extensión opcionales.', regex='^(((\\(\\+?\\d{2,3}\\))|(\\+?\\d{2,3}))[\\s\\-])?\\d{3}[\\s\\-]\\d{4}([\\s\\-]ext[\\s\\-]\\d{1,3})?$')])),
                ('celphone', models.CharField(default='', max_length=20, validators=[django.core.validators.RegexValidator(message='El número de celular debe ser entrado en el formato: (+xxx) xxx xxxx xxxx siendo el código de país opcional', regex='^((\\(\\+?\\d{2,3}\\))|(\\+?\\d{2,3})[\\s\\-])?\\d{3}([\\-\\s]\\d{4}){2}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_axis', models.CharField(choices=[('Dezlizamiento', 'Dezlizamiento'), ('Rodamiento', 'Rodamiento')], default='Undefined', max_length=13)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='company', to='backend.City')),
                ('rut_city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ruts', to='backend.City')),
            ],
        ),
        migrations.CreateModel(
            name='Coupling',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='date', to='backend.Company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, choices=[('sap', 'Sap'), ('int', 'Interno')], max_length=3, null=True)),
                ('electric_feed', models.CharField(blank=True, choices=[('sap', 'Sap'), ('int', 'Interno')], max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service', models.CharField(choices=[('pred', 'Predictivo'), ('corr', 'Correctivo'), ('eng', 'Ingenieria'), ('mon', 'Monitoreo en Linea')], default='pred', max_length=4)),
                ('measurement_type', models.CharField(choices=[('ult', 'Ultrasonido'), ('ter', 'Termografia'), ('vib', 'Vibracion'), ('adc', 'Analisis de Aceite'), ('pol', 'Alineacion Laser Polea'), ('tdb', 'Tencion de Bandas'), ('cmp', 'Correccion Montajes Poleas'), ('acp', 'Alineacion Laser Acople'), ('crd', 'Alineacion Laser Cardan'), ('egr', 'Alineacion Engranes'), ('adr', 'Alineacion Rodamientos'), ('bal', 'Balanceo'), ('cme', 'Chequeo Mecanico'), ('mes', 'Medicion Especial'), ('ayc', 'Aire y Caudal'), ('sum', 'Suministro')], default='vib', max_length=3)),
                ...
                ('analyst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='measurements_three', to=settings.AUTH_USER_MODEL)),
                ('certifier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='measurements_four', to=settings.AUTH_USER_MODEL)),
                ('date', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='measurements', to='backend.Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arduino', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sensor', to=settings.AUTH_USER_MODEL)),
                ('machine', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sensor', to='backend.Machine')),
            ],
        ),
        migrations.CreateModel(
            name='Point',
            fields=[
                ...
                ('point_type', models.CharField(choices=[('V', 'Velocity'), ('A', 'Acceleration'), ('D', 'Displacement'), ('T', 'Temperature'), ('E', 'Envol'), ('H', 'HFD'), ('M', 'Manual'), ('C', 'Calculado')], default='undefined', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gear_type', models.CharField(choices=[('Motor Eléctrico', 'Motor Eléctrico'), ('Motor Diesel', 'Motor Diesel'), ('Ventilador', 'Ventilador'), ('Bombda', 'Bombda'), ('Compresor', 'Compresor'), ('Generador', 'Generador'), ('Soplador', 'Soplador'), ('Molino', 'Molino'), ('Pelet', 'Pelet'), ('Zaranda', 'Zaranda'), ('Estructura', 'Estructura'), ('Extrusora', 'Extrusora'), ('Reductora', 'Reductora')], default='N/A', max_length=20)),
                ('support', models.CharField(choices=[('Rigido', 'Rigido'), ('Flexible', 'Flexible')], default='N/A', max_length=10)),
                ('transmission', models.CharField(choices=[('Flexibles', 'Flexibles'), ('Engranaje', 'Engranaje'), ('Cadena', 'Cadena'), ('Rejilla', 'Rejilla'), ('Morflex', 'Morflex'), ('Paraflex', 'Paraflex'), ('Araña', 'Araña'), ('Pasador', 'Pasador'), ('Laminilla', 'Laminilla'), ('Rigido', 'Rigido')], default='N/A', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('flaw_type', models.CharField(choices=[('bn', 'Bien'), ('bal', 'Balanceo'), ('ali', 'Alineacion'), ('ten', 'Tension'), ('lub', 'Lubricacion'), ('rod', 'Rodamientos'), ('hol', 'Holgura'), ('exc', 'Excentricidad'), ('sol', 'Soltura'), ('fra', 'Fractura'), ('vac', 'Vacio'), ('ele', 'Electrico'), ('ins', 'Inspeccion'), ('est', 'Estructural'), ('res', 'Resonancia'), ('nom', 'No medido'), ('otr', 'Otro')], default='otr', max_length=3)),
                ('severity', models.CharField(choices=[('red', 'Red'), ('green', 'Green'), ('yellow', 'Yellow'), ('black', 'Black')], default='black', max_length=9)),
        ...
        migrations.AddField(
            ...
            name='company',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user', to='backend.Company'),
        ),
        migrations.AddField(
            model_name='vibrouser',
            name='groups',
