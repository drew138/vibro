# Generated by Django 3.0.7 on 2020-11-29 19:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Nombre', max_length=30)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hierarchies', to='backend.Company')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.Hierarchy')),
            ],
        ),
        migrations.CreateModel(
            name='Machine',
            fields=[
                ...
                ('hierarchy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='machines', to='backend.Hierarchy')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', models.CharField(choices=[('red', 'Red'), ('green', 'Green'), ('yellow', 'Yellow'), ('black', 'Black'), ('undefined', 'Undefined')], default='undefined', max_length=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flaw', to='backend.Measurement')),
            ],
        ),
        migrations.CreateModel(
            name='Bearing',
            fields=[
                ...
                ('axis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bearing', to='backend.Axis')),
            ],
        ),
        migrations.AddField(
