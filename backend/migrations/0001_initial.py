# Generated by Django 3.0.7 on 2020-11-27 19:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gear_type', models.CharField(choices=[('Motor Eléctrico', 'Motor Eléctrico'), ('Motor Diesel', 'Motor Diesel'), ('Ventilador', 'Ventilador'), ('Bombda', 'Bombda'), ('Compresor', 'Compresor'), ('Generador Soplador', 'Generador Soplador'), ('Molino', 'Molino'), ('Pelet', 'Pelet'), ('Zaranda', 'Zaranda'), ('Estructura', 'Estructura'), ('Extrusora', 'Extrusora'), ('Reductora', 'Reductora')], default='N/A', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point_type', models.CharField(choices=[('V', 'Velocity'), ('A', 'Acceleration'), ('D', 'Displacement'), ('E', 'Envol'), ('H', 'HFD'), ('T', 'Temperature')], default='undefined', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('flaw_type', models.CharField(choices=[('bn', 'Bien'), ('bal', 'Balanceo'), ('ali', 'Alineacion'), ('ten', 'Tension'), ('lub', 'Lubricacion'), ('rod', 'Rodamientos'), ('hol', 'Holgura'), ('exc', 'Excentricidad'), ('sol', 'Soltura'), ('fra', 'Fractura'), ('vac', 'Vacio'), ('ele', 'Electrico'), ('ins', 'Inspeccion'), ('otr', 'Otro'), ('est', 'Estructural'), ('res', 'Resonancia'), ('nom', 'No medido')], default='otr', max_length=3)),
                ('severity', models.CharField(choices=[('red', 'Red'), ('green', 'Green'), ('yellow', 'Yellow'), ('black', 'Black'), ('undefined', 'Undefined')], default='undefined', max_length=9)),
