# Generated by Django 3.0.7 on 2020-06-08 18:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('engineer_one', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='eng_one', to=settings.AUTH_USER_MODEL)),
                ('engineer_two', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='eng_two', to=settings.AUTH_USER_MODEL)),
