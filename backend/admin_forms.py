...
ADDTIONAL_USER_FIELDS = (
    (None, {'fields': ('company', 'phone', 'ext',
                       'celphone_one', 'celphone_two', 'user_type')}),
)
ADDITIONAL_ADD_USER_FIELDS = (
    (None, {'fields': ('is_staff', 'email', 'user_type')}),
)
...
class MyUserAdmin(UserAdmin):
    ...
    model = VibroUser
    add_fieldsets = UserAdmin.add_fieldsets + ADDITIONAL_ADD_USER_FIELDS
